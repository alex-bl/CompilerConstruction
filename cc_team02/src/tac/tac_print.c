...
static const char *print_tac_op(enum mCc_tac_operation tac_operation)
{
	...
	case MCC_TAC_OPARATION_RETURN_ARRAY_STRING: return "RETURN_ARRAY_STRING";
	...
	case MCC_TAC_OPERATION_INT_ARR_INDEX_ACCESS: return "INDEX_ACC_INT_ARR";
	case MCC_TAC_OPERATION_FLOAT_ARR_INDEX_ACCESS: return "INDEX_ACC_FLOAT_ARR";
	case MCC_TAC_OPERATION_BOOL_ARR_INDEX_ACCESS: return "INDEX_ACC_BOOL_ARR";
	case MCC_TAC_OPERATION_STRING_ARR_INDEX_ACCESS:
		return "INDEX_ACC_STRING_ARR";
	}
	return "unknown";
}
