                              ...
                              struct mCc_tac_element *previous_tac)
{
	...
	struct mCc_tac_element *tac = tac_new_element(
	    ...
	    NULL, tac_new_identifier(declaration->identifier->identifier_name), MCC_TAC_TYPE_NO_TYPE, NULL);
                          ...
                          struct mCc_tac_element *previous_tac)
{
	...
	struct mCc_tac_element *tac = tac_new_element(
	    ...
	    tac_new_identifier(declaration->array_identifier->identifier_name), MCC_TAC_TYPE_NO_TYPE, NULL);
	mCc_tac_connect_tac_entry(previous_tac, tac);
	return tac;
}
