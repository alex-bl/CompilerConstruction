                                ...
                                void *data)
{
	...
	case MCC_AST_DATA_TYPE_INT: argument1=tac_new_identifier(((char) (expression->literal->i_value))); break;
	case MCC_AST_DATA_TYPE_FLOAT: argument1=tac_new_identifier((char) expression->literal->f_value); break;
	case MCC_AST_DATA_TYPE_BOOL: argument1=tac_new_identifier((char) expression->literal->b_value); break;
	case MCC_AST_DATA_TYPE_STRING: argument1=tac_new_identifier((char) expression->literal->s_value); break;
	default: argument1=NULL; break;
	}

	tac_new_element(MCC_TAC_OPARATION_COPY,
			argument1, NULL,
			argument1);
}
