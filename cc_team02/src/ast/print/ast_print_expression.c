                                      ...
                                      void *data)
{
	...
	mCc_ast_print_dot_edge_if_dest_exists(out, expression,
	                                      expression->next_expr, "next");
}
                                         ...
                                         void *data)
{
	...
	mCc_ast_print_dot_edge(out, expression, expression->identifier,
	                       "identifier");
	mCc_ast_print_dot_edge_if_dest_exists(out, expression,
	                                      expression->next_expr, "next");
}
    ...
    struct mCc_ast_expression *expression, void *data)
{
	...
	mCc_ast_print_dot_edge(out, expression, expression->array_identifier,
	                       "identifier");
    ...
    struct mCc_ast_expression *expression, void *data)
{
	...
	mCc_ast_print_dot_edge(out, expression, expression->function_call,
	                       "of-type");
	mCc_ast_print_dot_edge_if_dest_exists(out, expression,
	                                      expression->next_expr, "next");
}
