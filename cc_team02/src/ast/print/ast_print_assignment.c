                                        ...
                                        void *data)
{
	...
	mCc_ast_print_dot_edge(out, assignment, assignment->identifier,
	                       "identifier");
	mCc_ast_print_dot_edge(out, assignment, assignment->assigned_expression,
	                       "value");
}
                                    ...
                                    void *data)
{
	...
	mCc_ast_print_dot_edge(out, assignment, assignment->array_index_expression,
	                       "[index]");
	mCc_ast_print_dot_edge(out, assignment,
