...
void mCc_ast_visit_optional_next_function_def(
                                ...
                                struct mCc_ast_visitor *visitor)
{
	...
	// can be empty
	mCc_ast_visit_optional_next_statement(function_def->first_statement,
	                                      visitor);
	mCc_ast_visit_optional_next_declaration(function_def->first_parameter,
	                                        visitor);

	mCc_ast_visit_optional_next_function_def(function_def->next_function_def,
	                                         visitor);
                                 ...
                                 struct mCc_ast_visitor *visitor)
{
	...
	mCc_ast_visit_optional_next_expression(function_call->first_argument,
	                                       visitor);
