...
void mCc_assembly_param_int_array(FILE *out, struct mCc_assembly_data *data,
                                  struct mCc_tac_element *tac_elem)
{
	//	struct mCc_tac_identifier *size_identifier =
	// get_size_identifier(tac_elem); 	mCc_assembly_allocate_int_on_stack(out,
	// data, size_identifier->i_val);
}
...
{
	//	struct mCc_tac_identifier *size_identifier =
	// get_size_identifier(tac_elem); 	mCc_assembly_allocate_bool_on_stack(out,
	// data, size_identifier->i_val);
}
