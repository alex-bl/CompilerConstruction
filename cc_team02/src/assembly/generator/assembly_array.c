                                    ...
                                    struct mCc_tac_element *tac_elem)
{
	...
	struct mCc_tac_identifier *array_base =
	    get_arr_base_identifier(tac_elem);
	struct mCc_tac_identifier *array_index =
	    get_arr_index_identifier(tac_elem);
	...
	mCc_assembly_compute_index(out, INT_SIZE, offset_array_base, offset_array_index);
