                                     ...
                                     struct mCc_tac_element *tac_elem)
{
	...
	mCc_assembly_argument_int_primitive(out, data, tac_elem);
}
...
{
	/*TODO: special treatment here?*/
	mCc_assembly_argument_float_primitive(out, data, tac_elem);
}
...
{
	/*TODO: special treatment here?*/
	mCc_assembly_argument_bool_primitive(out, data, tac_elem);
}
...
{
	/*TODO: special treatment here?*/
	mCc_assembly_argument_string_primitive(out, data, tac_elem);
}
